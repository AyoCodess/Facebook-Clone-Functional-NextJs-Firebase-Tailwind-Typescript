...
export const InputboxModalTextareaFormUpdateComment = ({
  setSavedMessageRef,
  textareaRef,
  photoToPost,
  removePhotoToPost,
  ...
  console.log('in update comment input box textarea form');
  return (
    <form onClick={onClick} className='flex flex-col'>
      ...
      />
      {firebaseImageURL &&
        firebaseImageURL.imageURL === userCommentObject.imageURL && (
          <div
